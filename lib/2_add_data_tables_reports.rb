...
# ------------------- initialize species_sets data -----------------------------
  ...
  species_9 = ["Red-Tailed Hawk", "Buteo jamaicensis", "Animalia", "Chordata", "Aves", "Accipitriformes", nil, "Accipitridae", "Buteo", "Adults typically weigh from 690 to 1,600 g (1.5 to 3.5 lb) and measure 45 to 65 cm (18 to 26 in) in length, with a wingspan from 110 to 145 cm (43 to 57 in). The red-tailed hawk displays sexual dimorphism in size, with females typically a quarter heavier than males. Their most common prey are small mammals such as rodents and lagomorphs, but they will also consume birds, fish, reptiles and amphibians."]
